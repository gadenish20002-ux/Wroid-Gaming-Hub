...
- [x] **Step 3: Implement the typed request and state transitions**
...
- [x] **Step 4: Implement the process supervisor**
...
- [x] **Step 5: Run daemon tests green**
...
- [x] **Step 1: Replace the direct-spawn test with a failing typed-request test**
...
- [x] **Step 2: Run the focused CLI tests and confirm red**
...
- [x] **Step 3: Implement daemon launch and stop adapters**
...
- [x] **Step 4: Remove Hub child ownership**
...
- [x] **Step 3: Build and install the release**
...
- [x] **Step 4: Perform a stopped-runtime smoke audit**
